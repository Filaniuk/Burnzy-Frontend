...
export default function DashboardPlanModal({ channel, onClose, open }: DashboardPlanModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center">
      <div className="w-full max-w-md bg-[#1B1A24] border border-[#2E2D39] rounded-2xl p-6 text-white">
